...
$('#top').hide();
	...
	if (navigator.userAgent.match(/Android/i) ||
		...
		navigator.userAgent.match(/ZuneWP7/i)
			...
			$(".importPC").attr("href","/content/common/css/importsp.css");
			$(".stylePC").attr("href","/content/css/stylesp.css");
			$('head').append('<link rel="stylesheet" type="text/css" href="/Content/common/css/basesp.css"/>');
	}
});
