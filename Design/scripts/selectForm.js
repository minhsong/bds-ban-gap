$(function () {
    ...
    var defaults = {
	    ...
	    hiddenSuffix: "__formStyleHidden",
	   ...
	   //Also applied when user types something that is not in the options list
	    ...
	    //all callback functions are called in the scope of the current formStyle instance
    ...
    $.formStyle = function(selectbox, config) {
	    ...
	    this.wrapper = this.selectbox.hide().parent().addClass(this.config.skin); 
    ...
    $sc.fn.extend({
	    ...
	    setOverflow: function() {
		    var maxHeight = this.getListMaxHeight();
	        	...
	        	this.getListItemsHeight() > maxHeight
